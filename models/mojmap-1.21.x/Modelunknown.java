...
public class Modelunknown<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg", CubeListBuilder.create(),
				PartPose.offset(-3.0F, 17.5F, -23.0F));

		PartDefinition bone_r1 = rightleg
				.addOrReplaceChild("bone_r1",
						CubeListBuilder.create().texOffs(12, 26).addBox(-1.13F, -7.91F, -1.13F, 2.26F, 7.91F, 2.26F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));

		PartDefinition bone_r2 = rightleg.addOrReplaceChild("bone_r2",
				CubeListBuilder.create().texOffs(14, 15).addBox(-1.13F, -9.04F, -1.13F, 2.26F, 9.04F, 2.26F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.345F, 1.13F, 0.1309F, 0.0F, 0.0F));

		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg", CubeListBuilder.create(),
				PartPose.offset(3.78F, 17.5F, -23.0F));

		PartDefinition bone2_r1 = leftleg
				.addOrReplaceChild("bone2_r1",
						CubeListBuilder.create().texOffs(0, 28).addBox(-1.13F, -7.91F, -1.13F, 2.26F, 7.91F, 2.26F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1222F));

		PartDefinition bone2_r2 = leftleg.addOrReplaceChild("bone2_r2",
				CubeListBuilder.create().texOffs(16, 0).addBox(-1.13F, -9.04F, -1.13F, 2.26F, 9.04F, 2.26F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.345F, 1.13F, 0.1309F, 0.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-3.39F, -14.69F, -1.0125F, 6.78F, 7.56F, 2.425F, new CubeDeformation(0.0F)).texOffs(0, 15)
				.addBox(-2.89F, -7.19F, -1.1625F, 5.78F, 4.56F, 2.325F, new CubeDeformation(0.0F)).texOffs(14, 2)
				.addBox(-2.14F, -7.19F, -1.5375F, 4.28F, 4.06F, 1.7F, new CubeDeformation(0.0F)),
				PartPose.offset(0.39F, 12.415F, -23.0F));

		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(33, 15).addBox(-1.0F, -0.5F, -1.0F, 0.25F, 0.5F, 0.525F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(34, 15).addBox(-1.0F, -0.5F, -1.0F, 0.25F, 0.5F, 0.525F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(33, 15)
						.addBox(-1.0F, -0.5F, -1.0F, 0.25F, 0.5F, 0.525F, new CubeDeformation(0.0F)).texOffs(33, 15)
						.addBox(-1.0F, -0.5F, -1.0F, 0.25F, 0.5F, 0.525F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone5_r1 = body.addOrReplaceChild("bone5_r1",
				CubeListBuilder.create().texOffs(30, 6).addBox(-2.25F, -25.775F, -2.1625F, 3.03F, 7.06F, 1.825F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.64F, 11.585F, 0.25F, 0.0F, 0.3054F, 0.0F));

		PartDefinition bone5_r2 = body.addOrReplaceChild("bone5_r2",
				CubeListBuilder.create().texOffs(28, 29).addBox(-2.25F, -25.775F, -2.1625F, 3.03F, 7.06F, 1.825F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition lefthand = partdefinition.addOrReplaceChild("lefthand", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.91F, -2.275F, -23.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition bone3_r1 = lefthand.addOrReplaceChild("bone3_r1",
				CubeListBuilder.create().texOffs(0, 21).addBox(-5.6872F, 0.261F, -1.356F, 4.085F, 5.65F, 2.7403F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition righthand = partdefinition.addOrReplaceChild("righthand", CubeListBuilder.create(),
				PartPose.offset(-5.26F, 8.7425F, -23.0F));

		PartDefinition bone4_r1 = righthand
				.addOrReplaceChild("bone4_r1",
						CubeListBuilder.create().texOffs(20, 29).addBox(-1.13F, -2.26F, -1.13F, 2.26F, 7.91F, 2.26F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1309F, 0.0F, 0.0F));

		PartDefinition bone4_r2 = righthand.addOrReplaceChild("bone4_r2",
				CubeListBuilder.create().texOffs(22, 22).addBox(-5.9325F, -1.13F, -1.2147F, 4.335F, 5.65F, 2.5425F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.4975F, -8.7575F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition bone4_r3 = righthand.addOrReplaceChild("bone4_r3",
				CubeListBuilder.create().texOffs(22, 11).addBox(-1.13F, -1.13F, -1.13F, 2.26F, 9.04F, 2.26F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.4125F, -9.605F, 0.0F, 0.0436F, 0.0F, 0.1745F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-2.26F, -4.52F, -2.26F, 2.77F, 2.02F, 4.52F, new CubeDeformation(0.0F)).texOffs(30, 14)
						.addBox(-0.01F, -4.02F, -1.76F, 2.02F, 1.52F, 3.52F, new CubeDeformation(0.0F)).texOffs(0, 9)
						.addBox(-2.26F, -2.52F, -2.26F, 4.52F, 2.52F, 4.52F, new CubeDeformation(0.0F)).texOffs(30, 18)
						.addBox(-1.13F, -0.565F, -1.13F, 2.26F, 2.26F, 2.26F, new CubeDeformation(0.0F)).texOffs(33, 15)
						.addBox(0.91F, -4.035F, 0.0F, 0.25F, 0.5F, 0.525F, new CubeDeformation(0.0F)).texOffs(33, 15)
						.addBox(1.51F, -4.035F, 0.775F, 0.25F, 0.5F, 0.525F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = head.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(34, 14).addBox(-1.0F, -0.5F, -1.0F, 0.25F, 0.5F, 0.525F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = partdefinition.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offset(0.39F, -1.145F, -23.0F));
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0)
				...
				PartPose.offset(-80.0F, 24.0F, 0.0F));
